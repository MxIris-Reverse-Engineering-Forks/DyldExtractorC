...
template class DyldExtractor::Converter::Stubs::Fixer<Utils::Arch::arm>;
template class DyldExtractor::Converter::Stubs::Fixer<Utils::Arch::arm64>;
template class DyldExtractor::Converter::Stubs::Fixer<Utils::Arch::arm64_32>;
...
template <class A> void Converter::fixStubs(Utils::ExtractionContext<A> &eCtx) {
    if constexpr (std::is_same_v<A, Utils::Arch::arm> ||
        ...
        Converter::Stubs::Fixer<A>(eCtx).fix();
    }
