...
template class DyldExtractor::Provider::SymbolTableTracker<Utils::Arch::Pointer32>;
template class DyldExtractor::Provider::SymbolTableTracker<Utils::Arch::Pointer64>;
